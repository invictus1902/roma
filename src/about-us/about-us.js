...
const AboutUs = () => {
        ...
        <section className='about-us'>
            ...
            <div className="about-us__info">
                <div className="about-us__info__left">
                    ...
                    <p>Если вас интересует скупка плат в Бишкеке, то вы обратились по адресу. Компания «Radiolomkg»
    ...
    acar === 1 ? "about-us__info__left__akardion__bottom_ac" : ""
                            ...
                            <p>
                                ...
                                Необходим опыт, правильные реагенты и прямые руки, чтобы сделать всё правильно. Всё это
                                есть у нас, поэтому с нами выгодно сотрудничать.
                                <br/>
                                Мы предлагаем вам действительно выгодные условия сотрудничества в Бишкеке. Наша
                    ...
                    <div className="about-us__info__left__akardion">
                        <div className="about-us__info__left__akardion__top">
                            <h4>
                                <img src={Cisty} alt=""/>
                                Где выгодно продать платы и оборудование?
                            </h4>
                            <div onClick={acar === 2 ? ()=>act(0) : ()=>act(2)} className="about-us__info__left__akardion__top__p-a-p">
                                <div className="about-us__info__left__akardion__top__p-a-p__plus"></div>
                                <div className="about-us__info__left__akardion__top__p-a-p__minus"></div>
                            </div>
                        </div>
                        <div  className={`${acar === 2 ? 'about-us__info__left__akardion__bottom_ac' : 'about-us__info__left__akardion__bottom'}`}>
                            <p>Еще одним моментом, на который необходимо обращать внимание при выборе партнера – это
                                обоснованная стоимость покупки. Нечистые на руку скупщики стремятся максимально сбить
                                цену приема под любым предлогом.<br/>
                                Мы же обладаем соответствующими разрешительными документами на право скупки детялей
                                и плат. Мы работаем полностью легально и способны предоставить всю необходимую
                                подтверждающую и бухгалтерскую документацию. Кроме того, репутация компании для нас
                                – превыше всего. Поэтому мнение наших клиентов чрезвычайно важно. А добиться хороших
                                показателей доверия можно исключительно при построении доверительных отношений с
                                каждым поставщиком.<br/>
                                Чтобы избежать экономических потерь, следует внимательно изучить наше предложение,
                                сравнив его с аналогичными на рынке. Мы уверены, что после этого вы совершите выбор
                                в нашу пользу.</p>
                        </div>
                    </div>
                    <div className="about-us__info__left__line">
                    ...
                    <div className="about-us__info__left__akardion">
                        ...
                        <div  className={`${acar === 3 ? 'about-us__info__left__akardion__bottom_ac' : 'about-us__info__left__akardion__bottom'}`}>
                            <p>Чтобы продать радиоматериалы, содержащие драгметаллы, достаточно связаться с нашим
                                ...
                                день обращения и в 100% объеме. Способ выплаты выбираете самостоятельно. Квитанция –
                                также обязательный атрибут сделки. Бухгалтерские документы для юридических лиц
                                выдаются по запросу.<br/>
                                ...
                                любому поставщику, гибких условий мы являемся одним из лидеров Барнаула и
                                области.<br/>
